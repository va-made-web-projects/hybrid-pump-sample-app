  ...
  parseDataReading(data: DataView) {
    ...
    for (let offset = 0; offset < length; offset += chunkSize) {
      if (offset + 16 > length) break;
        // Read timestamp (first 4 bytes, little-endian)
